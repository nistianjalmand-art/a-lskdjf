...
from analysis.bottom_up import (
    build_bottom_up_levels,
    levels_to_dicts,
    get_trend_from_level,
    TF_MINUTES,
)
...
class BottomUpEngine:
    ...
    async def get_structure(
        ...
        Timestamps in levels_to_dicts() werden auf Chart-TF gesnapped
        damit LWC keine Ghost-Slots einfügt.
        """
        ...
        # chart_tf wird übergeben damit Timestamps auf den richtigen
        # TF-Slot gesnapped werden (Gap-Fix).
        levels_dict = levels_to_dicts(levels, chart_tf=timeframe)
